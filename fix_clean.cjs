...
// 4. Safely remove Dziennik Radiowy from the bottom
const drStrStart = '{/* --- DZIENNIK RADIOWY WIDGET --- */}';
const mapModalStart = '{/* MAP MODAL */}';
const i1 = app.indexOf(drStrStart);
const i2 = app.indexOf(mapModalStart);
if (i1 !== -1 && i2 !== -1) {
